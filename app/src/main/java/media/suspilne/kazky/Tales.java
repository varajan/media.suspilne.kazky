...
class Tales {
    ...
    private List<Tale> items = new ArrayList<>(Arrays.asList(
            ...
            new Tale(98, R.string.tale_098, R.string.jamala, R.drawable.t098),
            new Tale(99, R.string.tale_099, R.string.sergii_tanchynets, R.drawable.t099),
            new Tale(100, R.string.tale_100, R.string.sergii_tanchynets, R.drawable.t100),

            new Tale(101, R.string.tale_101, R.string.sergii_tanchynets, R.drawable.t101),
            new Tale(102, R.string.tale_102, R.string.inna_grebeniuk, R.drawable.t102),
            new Tale(103, R.string.tale_103, R.string.inna_grebeniuk, R.drawable.t103),
            new Tale(104, R.string.tale_104, R.string.inna_grebeniuk, R.drawable.t104),
            new Tale(105, R.string.tale_105, R.string.olga_shurova, R.drawable.t105),
            new Tale(106, R.string.tale_106, R.string.olga_shurova, R.drawable.t106),
            new Tale(107, R.string.tale_107, R.string.olga_shurova, R.drawable.t107),
            new Tale(108, R.string.tale_108, R.string.anastasiia_gudyma, R.drawable.t108),
            new Tale(109, R.string.tale_109, R.string.anastasiia_gudyma, R.drawable.t109),
            new Tale(110, R.string.tale_110, R.string.anastasiia_gudyma, R.drawable.t110),
...
//            new Tale(1, R.string.tale_1, R.string., R.drawable.t1),
//            new Tale(2, R.string.tale_2, R.string., R.drawable.t2),
//            new Tale(3, R.string.tale_3, R.string., R.drawable.t3),
//            new Tale(4, R.string.tale_4, R.string., R.drawable.t4),
//            new Tale(5, R.string.tale_5, R.string., R.drawable.t5),
//            new Tale(6, R.string.tale_6, R.string., R.drawable.t6),
//            new Tale(7, R.string.tale_7, R.string., R.drawable.t7),
//            new Tale(8, R.string.tale_8, R.string., R.drawable.t8),
//            new Tale(9, R.string.tale_9, R.string., R.drawable.t9),
//            new Tale(0, R.string.tale_0, R.string., R.drawable.t0),
            ));
}